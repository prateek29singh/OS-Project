...
int main()
{
	...
	int a=5,x;
	printf("********************************************************************************************************\n");
	printf("**********************   Press 1: When single cat is eating                         ********************\n");
	printf("*********************    press 2: When single mouse is eating                       ********************\n");
	printf("**********************   press 3: When cat sees mouse is eating then mouse will die ********************\n");
	printf("**********************   press 4: when mouse eats after cat eats it                 ********************\n");
	printf("**********************   press 5: When two cats ad mouse eats simultaneously   *************************\n");
	printf("********************************************************************************************************\n");
	scanf("%d",&x);
	switch(x)
	{
